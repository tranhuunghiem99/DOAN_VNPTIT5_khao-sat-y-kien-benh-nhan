...
<body>
	<div class="page-wrapper chiller-theme toggled">
		...
		<nav id="sidebar" class="sidebar-wrapper">
			<%@include
				file="/WEB-INF/views/jsp/admin/layoutadmin/sidlebarmenu.jsp"%>
					...
					<div class="form-group col-md-12">
						<div class="alert alert-success" role="alert">
							<div class="tab-content">
								<div id="view-kqks" class="container tab-pane fade">
									<%@include
										file="/WEB-INF/views/jsp/admin/layoutadmin/content-kqks.jsp"%>
								</div>
								<div id="das" class="container tab-pane active">
									<%@include
										file="/WEB-INF/views/jsp/admin/layoutadmin/content-users.jsp"%>
								</div>
								<div id="question" class="container tab-pane fade">
									<%@include
										file="/WEB-INF/views/jsp/admin/layoutadmin/content-question.jsp"%>
								</div>
								<div id="view-ks" class="container tab-pane fade">
									<%@include
										file="/WEB-INF/views/jsp/admin/layoutadmin/content-khaosat.jsp"%>
								</div>
	...
	<footer class="text-center">
		<%@include file="/WEB-INF/views/jsp/admin/layoutadmin/footer.jsp"%>
	</footer>
	<!-- page-content" -->
	</div>
	<!-- page-wrapper -->
